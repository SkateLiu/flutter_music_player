...
class MusicDao {
  static const URL_ROOT = 'http://localhost:3000';
  //歌
  ...
  static const URL_MV_URL = '$URL_ROOT/mv/url?r=1080&id=';
  ...
  // fm
  static const URL_DJ_HOT = '$URL_ROOT/dj/hot';
  ...
  static Future<String> getMVDetail(int id) async {
    var data = await HttpUtil.getJsonData('$URL_MV_URL$id', useCache: false);
    // 视频 240 480 720 1080  默认拿的480
  ...
  static Future<List> getHotDjList() async {
    var data = await HttpUtil.getJsonData(URL_DJ_HOT);
    List djList = data['djRadios'];
    return djList;
  }
}
